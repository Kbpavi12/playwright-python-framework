...
- Name: tests\salesforcePoC.spec.ts >> Salesforce Lead Management PoC >> Scenario 2: Should show error messages when mandatory fields are empty
- Location: tests\salesforcePoC.spec.ts:55:7
